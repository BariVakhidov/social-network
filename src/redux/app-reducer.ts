...
export const initializedSuccess = (): AppActionTypes => ({
  type: INITIALIZED_SUCCESS,
});
export const isBlackTheme = (blackTheme: boolean): AppActionTypes => ({
  type: BLACK_THEME,
  blackTheme,
});
export const setNavVisible = (visible: boolean): AppActionTypes => ({
